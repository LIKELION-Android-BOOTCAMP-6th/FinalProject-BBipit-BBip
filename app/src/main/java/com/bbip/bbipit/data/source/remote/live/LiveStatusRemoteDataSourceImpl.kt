...
class LiveStatusRemoteDataSourceImpl @Inject constructor(
     ...
     */
    override suspend fun updateLifeCycle(currentRoomId: String?, currentSessionId: String?) {
        val data = hashMapOf("currentRoomId" to currentRoomId, "clientSessionId" to currentSessionId)
