...
## 👥 Project Overview
* **개발 인원:** 4명
* **개발 기간:** 2026.05.04 ~ 2026.07.30

## 👤 Team Members
| 이름 | 역할 | 주요 업무 |
| :--- | :--- | :--- |
| **장지은(팀장)** | FE | 앱 골격 설계, 구글 플레이스토어 배포, OAuth2.0 기반 회원 인증(이메일/구글/카카오), 마이페이지(설정), 발표자료 및 시연영상 제작 |
| **정우석(부팀장)** | BE/FE | Google Maps API 지도 서비스, 실시간 위치 확인, Firebase 무전 기능, 백엔드 API 개발 |
| **이유빈(팀원)** | FE | 실시간 DM, 채팅방 관리, 친구 추가/조회/삭제, 프로필 수정, 발표자료 제작 |
